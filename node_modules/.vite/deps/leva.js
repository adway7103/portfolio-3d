...
} from "./chunk-JGO6TPYB.js";
import {
  require_react_dom
} from "./chunk-2GQIIDYH.js";
import {
  __awaiter,
  __generator,
  __spread
} from "./chunk-AZSR4MGD.js";
import {
  create
} from "./chunk-NBVPOE2Y.js";
import {
  require_react
...
// node_modules/leva/node_modules/@use-gesture/core/dist/maths-0ab39ae9.esm.js
function clamp(v4, min2, max2) {
  return Math.max(min2, Math.min(v4, max2));
}
var V2 = {
...
// node_modules/leva/node_modules/@use-gesture/core/dist/actions-fe213e88.esm.js
...
// node_modules/leva/node_modules/@use-gesture/react/dist/use-gesture-react.esm.js
var import_react6 = __toESM(require_react());

// node_modules/leva/node_modules/@use-gesture/core/dist/use-gesture-core.esm.js
...
function parse(newConfig, gestureKey, _config = {}) {
  const _ref = newConfig, {
    ...
    enabled,
    transform
  } = _ref, rest2 = _objectWithoutProperties(_ref, _excluded);
  ...
  bind(...args) {
    ...
    if (sharedConfig.enabled) {
      for (const gestureKey of this.gestures) {
        ...
        const bindFunction = bindToProps(props3, gestureConfig.eventOptions, !!target);
        if (gestureConfig.enabled) {
          const Engine2 = EngineMap.get(gestureKey);
          new Engine2(this, args, gestureKey).bind(bindFunction);
        }
      }
      const nativeBindFunction = bindToProps(props3, sharedConfig.eventOptions, !!target);
    ...
    for (const handlerProp in props3) {
      props3[handlerProp] = chain(...props3[handlerProp]);
    }
    if (!target)
      return props3;
    for (const handlerProp in props3) {
      ...
      this._targetEventStore.add(target, device, "", props3[handlerProp], {
        capture,
        passive
      });
    }
...
var bindToProps = (props3, eventOptions, withPassiveOption) => (device, action, handler, options = {}, isNative = false) => {
...
function useRecognizers(handlers, config = {}, gestureKey, nativeHandlers) {
  const ctrl = import_react6.default.useMemo(() => new Controller(handlers), []);
  ctrl.applyHandlers(handlers, nativeHandlers);
  ctrl.applyConfig(config, gestureKey);
  import_react6.default.useEffect(ctrl.effect.bind(ctrl));
...
function $c512c27ab02ef895$export$50c7b4e9d9f19c1(scopeName, createContextScopeDeps = []) {
  ...
  function $c512c27ab02ef895$export$fd42f52fd3ae1109(rootComponentName, defaultContext) {
    const BaseContext = (0, import_react7.createContext)(defaultContext);
    ...
    function Provider(props3) {
      ...
      return (0, import_react7.createElement)(Context3.Provider, {
        value
      }, children);
    }
    function useContext2(consumerName, scope) {
      const Context3 = (scope === null || scope === void 0 ? void 0 : scope[scopeName][index2]) || BaseContext;
      const context = (0, import_react7.useContext)(Context3);
      if (context)
        return context;
  ...
  const createScope = () => {
    const scopeContexts = defaultContexts.map((defaultContext) => {
      return (0, import_react7.createContext)(defaultContext);
    });
...
var $5cb92bef7577960e$export$177fb62ff3ec1f22 = (0, import_react10.forwardRef)((props3, forwardedRef) => {
...
var $5cb92bef7577960e$export$4d5eb2109db14228 = (0, import_react10.forwardRef)((props3, forwardedRef) => {
  const context = (0, import_react10.useContext)($5cb92bef7577960e$var$DismissableLayerContext);
  ...
  return (0, import_react10.createElement)($8927f6f2acc4f386$export$250ffa63cdc0d034.div, _extends({}, props3, {
    ref: composedRefs
  }));
});
...
var $7e8f5cd07187803e$export$21b07c8f274aebd5 = (0, import_react13.forwardRef)((props3, forwardedRef) => {
  ...
  }), props3.asChild ? children : (0, import_react13.createElement)("polygon", {
...
var $cf1ac5d9fe0e8206$export$ecd4e1ccab6ed6d = (0, import_react15.forwardRef)((props3, forwardedRef) => {
...
var $cf1ac5d9fe0e8206$export$bc4ae5855d3c4fc = (0, import_react15.forwardRef)((props3, forwardedRef) => {
  ...
  const [arrow3, setArrow] = (0, import_react15.useState)(null);
...
var $cf1ac5d9fe0e8206$export$79d62cd4e10a3fd0 = (0, import_react15.forwardRef)(function $cf1ac5d9fe0e8206$export$79d62cd4e10a3fd02(props3, forwardedRef) {
...
var $ea1ef594cf570d83$export$439d29a4e110a164 = (0, import_react18.forwardRef)((props3, forwardedRef) => {
  return (0, import_react18.createElement)($8927f6f2acc4f386$export$250ffa63cdc0d034.span, _extends({}, props3, {
    ref: forwardedRef,
    style: {
...
var $a093c7e1ec25a057$export$f78649fb9ca566b8 = (props3) => {
  ...
  const [isOpenDelayed, setIsOpenDelayed] = (0, import_react19.useState)(true);
  const isPointerInTransitRef = (0, import_react19.useRef)(false);
  const skipDelayTimerRef = (0, import_react19.useRef)(0);
  (0, import_react19.useEffect)(() => {
    const skipDelayTimer = skipDelayTimerRef.current;
    return () => window.clearTimeout(skipDelayTimer);
  }, []);
  return (0, import_react19.createElement)($a093c7e1ec25a057$var$TooltipProviderContextProvider, {
    scope: __scopeTooltip,
    isOpenDelayed,
    delayDuration,
    onOpen: (0, import_react19.useCallback)(() => {
    ...
    onPointerInTransitChange: (0, import_react19.useCallback)((inTransit) => {
...
var $a093c7e1ec25a057$export$28c660c63b792dea = (props3) => {
  ...
  const openTimerRef = (0, import_react19.useRef)(0);
  const disableHoverableContent = disableHoverableContentProp !== null && disableHoverableContentProp !== void 0 ? disableHoverableContentProp : providerContext.disableHoverableContent;
  const delayDuration = delayDurationProp !== null && delayDurationProp !== void 0 ? delayDurationProp : providerContext.delayDuration;
  const wasOpenDelayedRef = (0, import_react19.useRef)(false);
  ...
  const stateAttribute = (0, import_react19.useMemo)(() => {
  ...
  const handleDelayedOpen = (0, import_react19.useCallback)(() => {
    window.clearTimeout(openTimerRef.current);
  ...
  return (0, import_react19.createElement)($cf1ac5d9fe0e8206$export$be92b6f5f03c0fe9, popperScope, (0, import_react19.createElement)($a093c7e1ec25a057$var$TooltipContextProvider, {
    scope: __scopeTooltip,
    contentId,
    open: open1,
    stateAttribute,
    ...
    onTriggerEnter: (0, import_react19.useCallback)(() => {
    ...
    onTriggerLeave: (0, import_react19.useCallback)(() => {
...
var $a093c7e1ec25a057$export$8c610744efcf8a1d = (0, import_react19.forwardRef)((props3, forwardedRef) => {
  ...
  const hasPointerMoveOpenedRef = (0, import_react19.useRef)(false);
  const handlePointerUp = (0, import_react19.useCallback)(
...
var $a093c7e1ec25a057$export$7b36b8f925ab7497 = (props3) => {
  ...
  return (0, import_react19.createElement)($a093c7e1ec25a057$var$PortalProvider, {
    scope: __scopeTooltip,
    forceMount
  }, (0, import_react19.createElement)($921a889cee6df7e8$export$99c2b779aa4e8b8b, {
...
var $a093c7e1ec25a057$export$e9003e2be37ec060 = (0, import_react19.forwardRef)((props3, forwardedRef) => {
  ...
  return (0, import_react19.createElement)($921a889cee6df7e8$export$99c2b779aa4e8b8b, {
    present: forceMount || context.open
  }, context.disableHoverableContent ? (0, import_react19.createElement)($a093c7e1ec25a057$var$TooltipContentImpl, _extends({
    side
  }, contentProps, {
    ref: forwardedRef
  })) : (0, import_react19.createElement)($a093c7e1ec25a057$var$TooltipContentHoverable, _extends({
    side
  }, contentProps, {
    ref: forwardedRef
  })));
});
var $a093c7e1ec25a057$var$TooltipContentHoverable = (0, import_react19.forwardRef)((props3, forwardedRef) => {
  const context = $a093c7e1ec25a057$var$useTooltipContext($a093c7e1ec25a057$var$CONTENT_NAME, props3.__scopeTooltip);
  ...
  const ref = (0, import_react19.useRef)(null);
  const composedRefs = $6ed0406888f73fc4$export$c7b2cbe3552a0d05(forwardedRef, ref);
  const [pointerGraceArea, setPointerGraceArea] = (0, import_react19.useState)(null);
  const { trigger, onClose } = context;
  const content = ref.current;
  const { onPointerInTransitChange } = providerContext;
  const handleRemoveGraceArea = (0, import_react19.useCallback)(() => {
    setPointerGraceArea(null);
    onPointerInTransitChange(false);
  }, [
    onPointerInTransitChange
  ]);
  const handleCreateGraceArea = (0, import_react19.useCallback)((event, hoverTarget) => {
  ...
  return (0, import_react19.createElement)($a093c7e1ec25a057$var$TooltipContentImpl, _extends({}, props3, {
    ref: composedRefs
  }));
});
...
var $a093c7e1ec25a057$var$TooltipContentImpl = (0, import_react19.forwardRef)((props3, forwardedRef) => {
  ...
  return (0, import_react19.createElement)($5cb92bef7577960e$export$177fb62ff3ec1f22, {
    asChild: true,
    ...
    onDismiss: onClose
  }, (0, import_react19.createElement)($cf1ac5d9fe0e8206$export$7c6e2c02157bb7d2, _extends({
    "data-state": context.stateAttribute
  ...
  }), (0, import_react19.createElement)($5e63c961fc1ce211$export$d9f1ccf0bdb05d45, null, children), (0, import_react19.createElement)($a093c7e1ec25a057$var$VisuallyHiddenContentContextProvider, {
    scope: __scopeTooltip,
    isInside: true
  }, (0, import_react19.createElement)($ea1ef594cf570d83$export$be92b6f5f03c0fe9, {
...
var $a093c7e1ec25a057$export$c27ee0ad710f7559 = (0, import_react19.forwardRef)((props3, forwardedRef) => {
  ...
  return visuallyHiddenContentContext.isInside ? null : (0, import_react19.createElement)($cf1ac5d9fe0e8206$export$21b07c8f274aebd5, _extends({}, popperScope, arrowProps, {
    ref: forwardedRef
  }));
});
...
function getValueType(_ref) {
  let {
    value
  } = _ref, settings = _objectWithoutProperties2(_ref, _excluded$a);
...
function register(type, _ref2) {
  let {
    schema: schema3
  } = _ref2, plugin2 = _objectWithoutProperties2(_ref2, _excluded2$4);
  if (type in Plugins) {
...
function normalize$3(type, input, path, data) {
  ...
  const {
    value
  } = input, settings = _objectWithoutProperties2(input, _excluded3$1);
  return {
    value,
    settings
  };
...
var clamp3 = (x3, min2, max2) => x3 > max2 ? max2 : x3 < min2 ? min2 : x3;
var parseNumber = (v4) => {
...
function omit(object, keys) {
  const obj = _objectSpread22({}, object);
...
function parseOptions(_input, key, mergedOptions = {}, customType) {
  ...
  if ("__customInput" in _input) {
    const {
      type: _type,
      __customInput
    } = _input, options = _objectWithoutProperties2(_input, _excluded$9);
  ...
  const {
    ...
    onEditEnd,
    transient
  } = _input, inputWithType = _objectWithoutProperties2(_input, _excluded2$3);
  const commonOptions = _objectSpread22({
    render: render2,
    key,
  ...
  let {
    type
  } = inputWithType, input = _objectWithoutProperties2(inputWithType, _excluded3);
  ...
  return {
    type,
    input: computedInput,
    options: _objectSpread22(_objectSpread22({}, commonOptions), {}, {
      onChange,
...
var normalize$2 = (_ref) => {
  let {
    value
  } = _ref, settings = _objectWithoutProperties2(_ref, _excluded$8);
  const {
    min: min2 = -Infinity,
    max: max2 = Infinity
  } = settings, _settings = _objectWithoutProperties2(settings, _excluded2$2);
  let _value = parseFloat(value);
  const suffix = typeof value === "string" ? value.substring(("" + _value).length) : void 0;
  _value = clamp3(_value, min2, max2);
  ...
  const pad = Math.round(clamp3(Math.log10(1 / padStep), 0, 2));
  return {
    value: suffix ? _value + suffix : _value,
    settings: _objectSpread22({
      initialValue: _value,
      step,
      pad,
      min: min2,
...
var InputContext = (0, import_react20.createContext)({});
function useInputContext() {
  return (0, import_react20.useContext)(InputContext);
}
var ThemeContext = (0, import_react20.createContext)(null);
var StoreContext = (0, import_react20.createContext)(null);
var PanelSettingsContext = (0, import_react20.createContext)(null);
function useStoreContext() {
  return (0, import_react20.useContext)(StoreContext);
}
function usePanelSettingsContext() {
  return (0, import_react20.useContext)(PanelSettingsContext);
}
function LevaStoreProvider({
  children,
  store
}) {
  return import_react20.default.createElement(StoreContext.Provider, {
    value: store
  }, children);
}
var getDefaultTheme = () => ({
...
var {
  ...
  utils: _objectSpread22(_objectSpread22({}, utils), {}, {
    $flex: () => ({
      display: "flex",
      alignItems: "center"
    }),
...
function ValueInput(_ref) {
  let {
    ...
    inputType = "text",
    rows = 0
  } = _ref, props3 = _objectWithoutProperties2(_ref, _excluded$7);
  const {
    id: _id,
    emitOnEditStart,
    emitOnEditEnd,
  ...
  const update = (0, import_react20.useCallback)((fn) => (event) => {
  ...
  const onKeyPress = (0, import_react20.useCallback)((event) => {
    if (event.key === "Enter") {
  ...
  return import_react20.default.createElement(InputContainer, {
    textArea: isTextArea
  }, innerLabel && typeof innerLabel === "string" ? import_react20.default.createElement(InnerLabel, null, innerLabel) : innerLabel, import_react20.default.createElement(StyledInput, _extends2({
    levaType: type,
    ref: inputRef,
    id: inputId,
    type: inputType,
...
function NumberInput(_ref2) {
  let {
    onUpdate
  } = _ref2, props3 = _objectWithoutProperties2(_ref2, _excluded2$1);
  const _onUpdate = (0, import_react20.useCallback)((v4) => onUpdate(parseNumber(v4)), [onUpdate]);
  const onKeyDown = (0, import_react20.useCallback)((event) => {
  ...
  return import_react20.default.createElement(ValueInput, _extends2({}, props3, {
    onUpdate: _onUpdate,
    onKeyDown,
    type: "number"
  }));
...
function Portal({
  ...
  return import_react20.default.createElement($f1701beae083dbae$export$be92b6f5f03c0fe9, {
    className
  }, children);
}
...
function OptionalToggle() {
  ...
  return import_react20.default.createElement(import_react20.default.Fragment, null, import_react20.default.createElement(StyledOptionalToggle, {
    id: id + "__disable",
    type: "checkbox",
    checked: !disabled,
    onChange: () => disable(!disabled)
  }), import_react20.default.createElement("label", {
...
function RawLabel(props3) {
  ...
  return import_react20.default.createElement(import_react20.default.Fragment, null, optional2 && import_react20.default.createElement(OptionalToggle, null), hint !== void 0 ? import_react20.default.createElement($a093c7e1ec25a057$export$be92b6f5f03c0fe9, null, import_react20.default.createElement($a093c7e1ec25a057$export$41fb9f06171c75f4, {
    asChild: true
  }, import_react20.default.createElement(StyledLabel, _extends2({}, htmlFor, props3))), import_react20.default.createElement($a093c7e1ec25a057$export$7c6e2c02157bb7d2, {
    side: "top",
    sideOffset: 2
  }, import_react20.default.createElement(StyledToolTipContent, null, hint, import_react20.default.createElement(ToolTipArrow, null)))) : import_react20.default.createElement(StyledLabel, _extends2({}, htmlFor, title, props3)));
}
function Label(_ref) {
  let {
    align
  } = _ref, props3 = _objectWithoutProperties2(_ref, _excluded$6);
  const {
    value,
    label,
    key,
  ...
  return import_react20.default.createElement(CopyLabelContainer, {
    align,
    onPointerLeave: () => setCopied(false)
  }, import_react20.default.createElement(RawLabel, props3), copyEnabled && !disabled && import_react20.default.createElement("div", {
    title: `Click to copy ${typeof label === "string" ? label : key} value`
  }, !copied ? import_react20.default.createElement("svg", {
    onClick: handleClick,
...
function Chevron(_ref) {
  let {
    toggled
  } = _ref, props3 = _objectWithoutProperties2(_ref, _excluded$5);
  return import_react20.default.createElement(Svg, _extends2({
    width: "9",
    height: "5",
    viewBox: "0 0 9 5",
    xmlns: "http://www.w3.org/2000/svg",
  ...
  }, props3), import_react20.default.createElement("path", {
...
function Row(_ref) {
  let {
    input
  } = _ref, props3 = _objectWithoutProperties2(_ref, _excluded$4);
  if (input)
    return import_react20.default.createElement(StyledInputRow, props3);
  return import_react20.default.createElement(StyledRow, props3);
}
function useInputSetters({
  ...
  const [displayValue, setDisplayValue] = (0, import_react20.useState)(format$2(type, value, settings));
  const previousValueRef = (0, import_react20.useRef)(value);
  const settingsRef = (0, import_react20.useRef)(settings);
  settingsRef.current = settings;
  const setFormat = (0, import_react20.useCallback)((v4) => setDisplayValue(format$2(type, v4, settingsRef.current)), [type]);
  const onUpdate = (0, import_react20.useCallback)((updatedValue) => {
    try {
...
function useCanvas2d(fn) {
  const canvas = (0, import_react20.useRef)(null);
  const ctx = (0, import_react20.useRef)(null);
  const hasFired = (0, import_react20.useRef)(false);
  (0, import_react20.useEffect)(() => {
...
function useTransform() {
  ...
  const local = (0, import_react20.useRef)({
    x: 0,
    y: 0
  });
  const set = (0, import_react20.useCallback)((point) => {
...
var getInputAtPath = (data, path) => {
  if (!data[path])
    return null;
  const _data$path = data[path], input = _objectWithoutProperties2(_data$path, _excluded$3);
  return input;
};
function useInput(path) {
  const store = useStoreContext();
  const [state, setState] = (0, import_react20.useState)(getInputAtPath(store.getData(), path));
  const set = (0, import_react20.useCallback)((value) => store.setValueAtPath(path, value, true), [path, store]);
  const setSettings = (0, import_react20.useCallback)((settings) => store.setSettingsAtPath(path, settings), [path, store]);
  const disable = (0, import_react20.useCallback)((flag) => store.disableInputAtPath(path, flag), [path, store]);
  const emitOnEditStart = (0, import_react20.useCallback)(() => store.emitOnEditStart(path), [path, store]);
  const emitOnEditEnd = (0, import_react20.useCallback)(() => store.emitOnEditEnd(path), [path, store]);
  (0, import_react20.useEffect)(() => {
...
function RangeSlider({
  ...
  const ref = (0, import_react20.useRef)(null);
  const scrubberRef = (0, import_react20.useRef)(null);
  const rangeWidth = (0, import_react20.useRef)(0);
  ...
  return import_react20.default.createElement(RangeWrapper, _extends2({
    ref
  }, bind()), import_react20.default.createElement(Range, null, import_react20.default.createElement(Indicator, {
    style: {
      left: 0,
      right: `${(1 - pos) * 100}%`
    }
  })), import_react20.default.createElement(Scrubber, {
    ref: scrubberRef,
    style: {
...
var DraggableLabel = import_react20.default.memo(({
  label,
  onUpdate,
  step,
  innerLabelTrim
}) => {
  const [dragging, setDragging] = (0, import_react20.useState)(false);
  const bind = useDrag2(({
    active,
    delta: [dx],
    event,
  ...
  return import_react20.default.createElement(InnerNumberLabel, _extends2({
    dragging,
...
function Number$1({
  ...
  const InnerLabel2 = innerLabelTrim > 0 && import_react20.default.createElement(DraggableLabel, {
    label,
    step: settings.step,
    onUpdate,
    innerLabelTrim
  });
  return import_react20.default.createElement(NumberInput, {
    id,
...
function NumberComponent() {
  ...
  return import_react20.default.createElement(Row, {
    input: true
  }, import_react20.default.createElement(Label, null, label), import_react20.default.createElement(RangeGrid, {
    hasRange
  }, hasRange && import_react20.default.createElement(RangeSlider, _extends2({
    value: parseFloat(value),
    onDrag: onUpdate
  }, settings)), import_react20.default.createElement(Number$1, _extends2({}, props3, {
    id,
    label: "value",
...
var rest = _objectWithoutProperties2(props$3, ["sanitizeStep"]);
var number = createInternalPlugin(_objectSpread22({
...
function Select({
  ...
  const lastDisplayedValue = (0, import_react20.useRef)();
  if (value === values[displayValue]) {
    lastDisplayedValue.current = keys[displayValue];
  }
  return import_react20.default.createElement(SelectContainer, null, import_react20.default.createElement(NativeSelect, {
    id,
    value: displayValue,
    onChange: (e4) => onUpdate(values[Number(e4.currentTarget.value)]),
    disabled
  }, keys.map((key, index2) => import_react20.default.createElement("option", {
    key,
    value: index2
  }, key))), import_react20.default.createElement(PresentationalSelect, null, lastDisplayedValue.current), import_react20.default.createElement(Chevron, {
    toggled: true
  }));
}
function SelectComponent() {
  ...
  return import_react20.default.createElement(Row, {
    input: true
  }, import_react20.default.createElement(Label, null, label), import_react20.default.createElement(Select, {
    id,
    value,
    displayValue,
    onUpdate,
...
var select = createInternalPlugin(_objectSpread22({
...
function String$1(_ref) {
  let {
    ...
    onChange,
    editable = true
  } = _ref, props3 = _objectWithoutProperties2(_ref, _excluded$2);
  if (editable)
    return import_react20.default.createElement(ValueInput, _extends2({
      value: displayValue,
      onUpdate,
      onChange
    }, props3));
  return import_react20.default.createElement(NonEditableString, null, displayValue);
}
function StringComponent() {
  ...
  return import_react20.default.createElement(Row, {
    input: true
  }, import_react20.default.createElement(Label, null, label), import_react20.default.createElement(String$1, _extends2({
    displayValue,
    onUpdate,
    onChange
  }, settings)));
}
var string = createInternalPlugin(_objectSpread22({
...
function Boolean2({
  ...
  return import_react20.default.createElement(StyledInputWrapper, null, import_react20.default.createElement("input", {
    id,
    type: "checkbox",
    checked: value,
...
function BooleanComponent() {
  ...
  return import_react20.default.createElement(Row, {
    input: true
  }, import_react20.default.createElement(Label, null, label), import_react20.default.createElement(Boolean2, {
    value,
    onUpdate,
    id,
    disabled
...
var boolean = createInternalPlugin(_objectSpread22({
...
function Coordinate({
  ...
  const valueRef = (0, import_react20.useRef)(value[valueKey]);
  valueRef.current = value[valueKey];
  const setValue = (0, import_react20.useCallback)((newValue) => onUpdate({
  ...
  return import_react20.default.createElement(Number$1, {
    id,
    label: valueKey,
    value: value[valueKey],
...
function Lock(_ref) {
  let {
    locked
  } = _ref, props3 = _objectWithoutProperties2(_ref, _excluded$1);
  return import_react20.default.createElement("svg", _extends2({
    width: "10",
    height: "10",
    viewBox: "0 0 15 15",
    fill: "none",
    xmlns: "http://www.w3.org/2000/svg"
  }, props3), locked ? import_react20.default.createElement("path", {
...
function Vector({
  ...
  return import_react20.default.createElement(Container, {
    withLock: lock
  }, lock && import_react20.default.createElement(Lock, {
    locked,
    onClick: () => setSettings({
      locked: !locked
    })
  }), Object.keys(value).map((key, i4) => import_react20.default.createElement(Coordinate, {
    id: i4 === 0 ? id : `${id}.${key}`,
    key,
    valueKey: key,
    value,
...
var normalizeKeyedNumberSettings = (value, settings) => {
  ...
  Object.entries(value).forEach(([key, v4]) => {
    _settings[key] = normalize$2(_objectSpread22({
      value: v4
...
var sanitizeVector = (value, settings, previousValue) => {
  ...
  if (_valueKeys.length === settings.keys.length)
    ...
    if (_valueKeys.length === 1 && settings.locked) {
      ...
      newValue = _objectSpread22(_objectSpread22({}, _previousValue), _value);
    }
  }
...
function normalizeVector(value, settings, defaultKeys = []) {
  const {
    lock = false
  } = settings, _settings = _objectWithoutProperties2(settings, _excluded2);
  ...
  return {
    ...
    settings: _objectSpread22(_objectSpread22({}, numberSettings), {}, {
      format: format3,
      keys,
      lock,
      locked: false
...
function getVectorPlugin(defaultKeys) {
  return {
    ...
    normalize: (_ref) => {
      let {
        value
      } = _ref, settings = _objectWithoutProperties2(_ref, _excluded22);
...
function i3(e4) {
  var t4 = (0, import_react23.useRef)(e4), n4 = (0, import_react23.useRef)(function(e5) {
...
var m3 = import_react23.default.memo(function(o4) {
  var a4 = o4.onMove, l4 = o4.onKey, s4 = c3(o4, ["onMove", "onKey"]), m4 = (0, import_react23.useRef)(null), g4 = i3(a4), p4 = i3(l4), b4 = (0, import_react23.useRef)(null), _2 = (0, import_react23.useRef)(false), x3 = (0, import_react23.useMemo)(function() {
    var e4 = function(e5) {
  ...
  return (0, import_react23.useEffect)(function() {
    return H3;
  }, [H3]), import_react23.default.createElement("div", u3({}, s4, { onTouchStart: C2, onMouseDown: C2, className: "react-colorful__interactive", ref: m4, onKeyDown: E2, tabIndex: 0, role: "slider" }));
});
var g3 = function(e4) {
...
var p3 = function(r4) {
  ...
  return import_react23.default.createElement("div", { className: l4, style: { top: 100 * a4 + "%", left: 100 * n4 + "%" } }, import_react23.default.createElement("div", { className: "react-colorful__pointer-fill", style: { backgroundColor: t4 } }));
};
...
var S3 = import_react23.default.memo(function(r4) {
  var t4 = r4.hue, n4 = r4.onChange, o4 = g3(["react-colorful__hue", r4.className]);
  return import_react23.default.createElement("div", { className: o4 }, import_react23.default.createElement(m3, { onMove: function(e4) {
    n4({ h: 360 * e4.left });
  }, onKey: function(e4) {
    n4({ h: s3(t4 + 360 * e4.left, 0, 360) });
  }, "aria-label": "Hue", "aria-valuenow": b3(t4), "aria-valuemax": "360", "aria-valuemin": "0" }, import_react23.default.createElement(p3, { className: "react-colorful__hue-pointer", left: t4 / 360, color: q2({ h: t4, s: 100, v: 100, a: 1 }) })));
});
var T2 = import_react23.default.memo(function(r4) {
  var t4 = r4.hsva, n4 = r4.onChange, o4 = { backgroundColor: q2({ h: t4.h, s: 100, v: 100, a: 1 }) };
  return import_react23.default.createElement("div", { className: "react-colorful__saturation", style: o4 }, import_react23.default.createElement(m3, { onMove: function(e4) {
    n4({ s: 100 * e4.left, v: 100 - 100 * e4.top });
  }, onKey: function(e4) {
    n4({ s: s3(t4.s + 100 * e4.left, 0, 100), v: s3(t4.v - 100 * e4.top, 0, 100) });
  }, "aria-label": "Color", "aria-valuetext": "Saturation " + b3(t4.s) + "%, Brightness " + b3(t4.v) + "%" }, import_react23.default.createElement(p3, { className: "react-colorful__saturation-pointer", top: 1 - t4.v / 100, left: t4.s / 100, color: q2(t4) })));
});
...
function Y2(e4, t4, l4) {
  var u4 = i3(l4), c4 = (0, import_react23.useState)(function() {
    return e4.toHsva(t4);
  }), s4 = c4[0], f4 = c4[1], v4 = (0, import_react23.useRef)({ color: t4, hsva: s4 });
  (0, import_react23.useEffect)(function() {
    if (!e4.equal(t4, v4.current.color)) {
      var r4 = e4.toHsva(t4);
      v4.current = { hsva: r4, color: t4 }, f4(r4);
    }
  }, [t4, e4]), (0, import_react23.useEffect)(function() {
    var r4;
    F2(s4, v4.current.hsva) || e4.equal(r4 = e4.fromHsva(s4), v4.current.color) || (v4.current = { hsva: s4, color: r4 }, u4(r4));
  }, [s4, e4, u4]);
  var d4 = (0, import_react23.useCallback)(function(e5) {
    f4(function(r4) {
...
var R2;
var V3 = "undefined" != typeof window ? import_react23.useLayoutEffect : import_react23.useEffect;
var $3 = function() {
...
var U2 = function(t4) {
  var n4 = t4.className, o4 = t4.colorModel, a4 = t4.color, l4 = void 0 === a4 ? o4.defaultColor : a4, i4 = t4.onChange, s4 = c3(t4, ["className", "colorModel", "color", "onChange"]), f4 = (0, import_react23.useRef)(null);
  Q(f4);
  var v4 = Y2(o4, l4, i4), d4 = v4[0], h4 = v4[1], m4 = g3(["react-colorful", n4]);
  return import_react23.default.createElement("div", u3({}, s4, { ref: f4, className: m4 }), import_react23.default.createElement(T2, { hsva: d4, onChange: h4 }), import_react23.default.createElement(S3, { hue: d4.h, onChange: h4, className: "react-colorful__last-control" }));
};
var ee = function(r4) {
  ...
  return import_react23.default.createElement("div", { className: l4 }, import_react23.default.createElement("div", { className: "react-colorful__alpha-gradient", style: a4 }), import_react23.default.createElement(m3, { onMove: function(e4) {
    o4({ a: e4.left });
  }, onKey: function(e4) {
    o4({ a: s3(n4.a + e4.left) });
  }, "aria-label": "Alpha", "aria-valuetext": u4 + "%", "aria-valuenow": u4, "aria-valuemin": "0", "aria-valuemax": "100" }, import_react23.default.createElement(p3, { className: "react-colorful__alpha-pointer", left: n4.a, color: k3(n4) })));
};
var re = function(t4) {
  var n4 = t4.className, o4 = t4.colorModel, a4 = t4.color, l4 = void 0 === a4 ? o4.defaultColor : a4, i4 = t4.onChange, s4 = c3(t4, ["className", "colorModel", "color", "onChange"]), f4 = (0, import_react23.useRef)(null);
  Q(f4);
  var v4 = Y2(o4, l4, i4), d4 = v4[0], h4 = v4[1], m4 = g3(["react-colorful", n4]);
  return import_react23.default.createElement("div", u3({}, s4, { ref: f4, className: m4 }), import_react23.default.createElement(T2, { hsva: d4, onChange: h4 }), import_react23.default.createElement(S3, { hue: d4.h, onChange: h4 }), import_react23.default.createElement(ee, { hsva: d4, onChange: h4, className: "react-colorful__last-control" }));
};
var xe = { defaultColor: { r: 0, g: 0, b: 0, a: 1 }, toHsva: L2, fromHsva: I3, equal: F2 };
var Ce = function(r4) {
  return import_react23.default.createElement(re, u3({}, r4, { colorModel: xe }));
};
...
var Ne = function(r4) {
  return import_react23.default.createElement(U2, u3({}, r4, { colorModel: Me }));
};
  ...
  return [{
    ...
    accept: Array.isArray(accept) ? (
      ...
      accept.filter(function(item) {
        ...
        return _objectSpread(_objectSpread({}, a4), {}, _defineProperty3({}, b4, []));
      }, {})
    ) : {}
  }];
}
...
function _objectSpread3(target) {
  for (var i4 = 1; i4 < arguments.length; i4++) {
    var source = null != arguments[i4] ? arguments[i4] : {};
    i4 % 2 ? ownKeys4(Object(source), true).forEach(function(key) {
...
var Dropzone = (0, import_react24.forwardRef)(function(_ref, ref) {
  var children = _ref.children, params = _objectWithoutProperties3(_ref, _excluded4);
  var _useDropzone = useDropzone(params), open = _useDropzone.open, props3 = _objectWithoutProperties3(_useDropzone, _excluded23);
  (0, import_react24.useImperativeHandle)(ref, function() {
    return {
      open
    };
  }, [open]);
  return import_react24.default.createElement(import_react24.Fragment, null, children(_objectSpread3(_objectSpread3({}, props3), {}, {
    open
  })));
});
...
function useDropzone() {
  ...
  var onFileDialogOpenCb = (0, import_react24.useMemo)(function() {
    return typeof onFileDialogOpen === "function" ? onFileDialogOpen : noop2;
  }, [onFileDialogOpen]);
  var onFileDialogCancelCb = (0, import_react24.useMemo)(function() {
    return typeof onFileDialogCancel === "function" ? onFileDialogCancel : noop2;
  }, [onFileDialogCancel]);
  var rootRef = (0, import_react24.useRef)(null);
  var inputRef = (0, import_react24.useRef)(null);
  var _useReducer = (0, import_react24.useReducer)(reducer, initialState), _useReducer2 = _slicedToArray2(_useReducer, 2), state = _useReducer2[0], dispatch = _useReducer2[1];
  var isFocused = state.isFocused, isFileDialogActive = state.isFileDialogActive, draggedFiles = state.draggedFiles;
  var fsAccessApiWorksRef = (0, import_react24.useRef)(typeof window !== "undefined" && window.isSecureContext && useFsAccessApi && canUseFileSystemAccessAPI());
  ...
  var dragTargetsRef = (0, import_react24.useRef)([]);
  ...
  var onDragEnterCb = (0, import_react24.useCallback)(function(event) {
    event.preventDefault();
    event.persist();
  ...
  var onDragOverCb = (0, import_react24.useCallback)(function(event) {
    event.preventDefault();
    event.persist();
    stopPropagation(event);
  ...
  var onDragLeaveCb = (0, import_react24.useCallback)(function(event) {
    event.preventDefault();
    event.persist();
    stopPropagation(event);
  ...
  var setFiles = (0, import_react24.useCallback)(function(files, event) {
    var acceptedFiles = [];
    var fileRejections = [];
  ...
  var onDropCb = (0, import_react24.useCallback)(function(event) {
    event.preventDefault();
    event.persist();
    stopPropagation(event);
    dragTargetsRef.current = [];
  ...
  var openFileDialog = (0, import_react24.useCallback)(function() {
  ...
  var onKeyDownCb = (0, import_react24.useCallback)(function(event) {
  ...
  var onFocusCb = (0, import_react24.useCallback)(function() {
    dispatch({
      type: "focus"
    });
  }, []);
  var onBlurCb = (0, import_react24.useCallback)(function() {
    dispatch({
      type: "blur"
    });
  }, []);
  var onClickCb = (0, import_react24.useCallback)(function() {
    if (noClick) {
      return;
    }
    if (isIeOrEdge()) {
  ...
  var getRootProps = (0, import_react24.useMemo)(function() {
    return function() {
      var _ref2 = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, _ref2$refKey = _ref2.refKey, refKey = _ref2$refKey === void 0 ? "ref" : _ref2$refKey, role = _ref2.role, onKeyDown = _ref2.onKeyDown, onFocus = _ref2.onFocus, onBlur = _ref2.onBlur, onClick = _ref2.onClick, onDragEnter2 = _ref2.onDragEnter, onDragOver2 = _ref2.onDragOver, onDragLeave2 = _ref2.onDragLeave, onDrop2 = _ref2.onDrop, rest2 = _objectWithoutProperties3(_ref2, _excluded32);
      return _objectSpread3(_objectSpread3(_defineProperty4({
  ...
  var onInputElementClick = (0, import_react24.useCallback)(function(event) {
    event.stopPropagation();
  }, []);
  var getInputProps = (0, import_react24.useMemo)(function() {
    return function() {
      var _ref3 = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, _ref3$refKey = _ref3.refKey, refKey = _ref3$refKey === void 0 ? "ref" : _ref3$refKey, onChange = _ref3.onChange, onClick = _ref3.onClick, rest2 = _objectWithoutProperties3(_ref3, _excluded42);
...
function useValuesForPath(store, paths, initialData) {
  const valuesForPath = store.useStore((s4) => {
    const data = _objectSpread22(_objectSpread22({}, initialData), s4.data);
...
var format$12 = (v4, settings) => {
  return convert2(w2(v4), _objectSpread22(_objectSpread22({}, settings), {}, {
    isString: true,
    format: "hex"
  }));
};
...
var color = createInternalPlugin(_objectSpread22({
...
var vector3d = createInternalPlugin(_objectSpread22({
...
function Joystick({
  ...
  const bind = useDrag2(({
    ...
    const _x = clamp3(mx, -w3, w3);
    const _y = clamp3(my, -h4, h4);
...
var normalize$22 = (_ref) => {
  let {
    joystick = true
  } = _ref, input = _objectWithoutProperties2(_ref, _excluded$72);
  const {
    value,
    settings
  ...
  return {
    value,
    settings: _objectSpread22(_objectSpread22({}, settings), {}, {
      joystick
    })
  };
};
var vector2d = createInternalPlugin(_objectSpread22(_objectSpread22({
...
var image = createInternalPlugin(_objectSpread22({
...
var sanitize2 = (value, {
  ...
  const {
    min: min2,
    max: max2
  } = _objectSpread22(_objectSpread22({}, _newValue), _value);
  return [clamp3(Number(min2), MIN, Math.max(MIN, max2)), clamp3(Number(max2), Math.min(MAX, min2), MAX)];
};
var normalize2 = ({
  value,
  min: min2,
  ...
  const settings = _objectSpread22(_objectSpread22({}, _settings), {}, {
    bounds
  });
...
function IntervalSlider(_ref) {
  let {
    ...
    bounds: [min2, max2],
    onDrag
  } = _ref, settings = _objectWithoutProperties2(_ref, _excluded$62);
...
function IntervalComponent() {
  ...
  const _settings = _objectWithoutProperties2(settings, _excluded2$12);
...
var interval = createInternalPlugin(_objectSpread22({
...
var _excluded24 = ["onChange", "transient", "onEditStart", "onEditEnd"];
var Store = function Store2() {
      ...
      Object.entries(newData).forEach(([path, newInputData]) => {
        ...
        if (!!input) {
          const {
            type,
            value
          } = newInputData, rest2 = _objectWithoutProperties2(newInputData, _excluded$52);
          if (type !== input.type) {
          ...
          data[path] = _objectSpread22(_objectSpread22({}, newInputData), {}, {
            __refCount: 1
          });
        }
      });
  ...
  this.setSettingsAtPath = (path, settings) => {
    store.setState((s4) => {
      const data = s4.data;
      data[path].settings = _objectSpread22(_objectSpread22({}, data[path].settings), settings);
      return {
        data
      };
    });
  ...
  this.emitOnEditStart = (path) => {
    eventEmitter.emit(`onEditStart:${path}`, this.get(path), path, _objectSpread22(_objectSpread22({}, this.getInput(path)), {}, {
      get: this.get
    }));
  };
  this.emitOnEditEnd = (path) => {
    eventEmitter.emit(`onEditEnd:${path}`, this.get(path), path, _objectSpread22(_objectSpread22({}, this.getInput(path)), {}, {
      get: this.get
    }));
  };
      ...
      if (rawInput.type === SpecialInputs.FOLDER) {
        ...
        if (normalizedInput) {
          ...
          const {
            ...
            onEditStart,
            onEditEnd
          } = options, _options = _objectWithoutProperties2(options, _excluded24);
          data[newPath] = _objectSpread22(_objectSpread22(_objectSpread22({
            type
          }, _options), input), {}, {
            fromPanel: true
          });
...
function folder(schema3, settings) {
  return {
    ...
    schema: schema3,
    settings: _objectSpread22(_objectSpread22({}, defaultSettings$2), settings)
  };
}
...
function button(onClick, settings) {
  return {
    ...
    onClick,
    settings: _objectSpread22(_objectSpread22({}, defaultSettings$1), settings)
  };
}
...
function monitor(objectOrFn, settings) {
  return {
    ...
    objectOrFn,
    settings: _objectSpread22(_objectSpread22({}, defaultSettings), settings)
  };
}
...
function ControlInput(_ref) {
  let {
    ...
    setValue,
    disabled
  } = _ref, rest2 = _objectWithoutProperties2(_ref, _excluded$42);
  const {
    displayValue,
    onChange,
    onUpdate
...
var MonitorCanvas = (0, import_react25.forwardRef)(function({
  ...
  const min2 = (0, import_react25.useRef)(initialValue);
  const max2 = (0, import_react25.useRef)(initialValue);
...
var parse2 = (val) => Number.isFinite(val) ? val.toPrecision(2) : val.toString();
var MonitorLog = (0, import_react25.forwardRef)(function({
  initialValue
}, ref) {
  const [val, set] = (0, import_react25.useState)(parse2(initialValue));
  (0, import_react25.useImperativeHandle)(ref, () => ({
    frame: (v4) => set(parse2(v4))
  }), []);
...
var Control = import_react25.default.memo(({
  ...
  const {
    ...
    label,
    key
  } = input, inputProps = _objectWithoutProperties2(input, _excluded$32);
  if (type in SpecialInputs) {
...
function LevaRoot(_ref) {
  let {
    ...
    theme,
    collapsed = false
  } = _ref, props3 = _objectWithoutProperties2(_ref, _excluded$22);
...
function Leva(_ref) {
  let {
    isRoot = false
  } = _ref, props3 = _objectWithoutProperties2(_ref, _excluded$12);
  (0, import_react25.useEffect)(() => {
    ...
    if (isGlobalPanel && !rootInitialized) {
      if (!rootEl) {
        ...
        if (document.body) {
          ...
          render(import_react25.default.createElement(Leva, {
            isRoot: true
          }), rootEl);
        }
      }
...
function LevaPanel(_ref) {
  let {
    store
  } = _ref, props3 = _objectWithoutProperties2(_ref, _excluded5);
...
function useControls(schemaOrFolderName, settingsOrDepsOrSchema, depsOrSettingsOrFolderSettings, depsOrSettings, depsOrUndefined) {
  ...
  (0, import_react25.useEffect)(() => {
    ...
    Object.entries(onChangePaths).forEach(([path, onChange]) => {
      onChange(store.get(path), path, _objectSpread22({
        initial: true,
        get: store.get
      }, store.getInput(path)));
      const unsub = store.useStore.subscribe((s4) => {
        ...
        return [value, input];
      }, ([value, input]) => onChange(value, path, _objectSpread22({
        initial: false,
        get: store.get
      }, input)), {
        equalityFn: shallow
